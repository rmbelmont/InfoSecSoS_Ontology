		...
		<div class="row d-flex justify-content-center align-items-center">
			<div class="col-md-8">
				<form action="<%=request.getContextPath()%>/Form_07"
					method="get">
					<div>
						<h6>2 - What algorithm solutions are currently found in systems-of-systems in InfoSecSoS?</h6>
		...
		<div class="row d-flex justify-content-center align-items-center">
			<div class="col-md-8">
				<form action="<%=request.getContextPath()%>/Form_05"
					method="get">
					<div>
						<h6>3 - What are the information security assessment methods of systems-of-systems in InfoSecSoS?</h6>
		...
		<div class="row d-flex justify-content-center align-items-center">
			<div class="col-md-8">
				<form action="<%=request.getContextPath()%>/Form_03"
					method="get">
					<div>
						<h6>4 - What are the specific factors of information security in InfoSecSoS?</h6>
		...
		<div class="row d-flex justify-content-center align-items-center">
			<div class="col-md-8">
				<form action="<%=request.getContextPath()%>/Form_02"
					method="get">
					<div>
						<h6>5 - What are the systems-of-systems information security technologies, models, techniques, or tools in InfoSecSoS?</h6>
		...
		<div class="row d-flex justify-content-center align-items-center">
			<div class="col-md-8">
				<form action="<%=request.getContextPath()%>/Form_04"
					method="get">
					<div>
						<h6>6 - What are the types of information security human factors in InfoSecSoS?</h6>
		...
		<div class="row d-flex justify-content-center align-items-center">
			<div class="col-md-8">
				<form action="<%=request.getContextPath()%>/Form_06"
					method="get">
					<div>
						<h6>7 - What encryption solutions are currently found in systems-of-systems in InfoSecSoS?</h6>
		...
		<div class="row d-flex justify-content-center align-items-center">
			<div class="col-md-8">
				<form action="<%=request.getContextPath()%>/Form_07"
					method="get">
					<div>
						<h6>9 - Search for information security algorithm in systems-of-systems in InfoSecSoS..</h6>
						<p>
		...
		<div class="row d-flex justify-content-center align-items-center">
			<div class="col-md-8">
				<form action="<%=request.getContextPath()%>/Form_07"
					method="get">
					<div>
						<h6>10 - Search for information security encryption in systems-of-systems in InfoSecSoS.</h6>
						<p>
