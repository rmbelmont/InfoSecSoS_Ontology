...
/**
 * Servlet implementation class Formulario9 - Busca de Algoritmos
 */
@WebServlet("/Form_09")
public class Form_09 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            resposta1 = Principal.buscarAlgoritmoPorNome2(resposta2, algoritmo);
        ...
        out.println("<title>InfoSecSoS Ontology - Resultado da Busca por Algoritmo</title>");
        ...
        out.println("    padding: 20px;");
        out.println("    background: rgba(20, 184, 166, 0.05);");
        ...
        out.println("<div class='subtitle'><i class='bi bi-search me-1'></i> Resultado da Busca por Algoritmo</div>");
        out.println("</div>");
        ...
        out.println("<i class='bi bi-cpu'></i>");
        out.println("</div>");
        out.println("<div class='search-info'>");
        out.println("<div class='search-term'>");
        out.println("Termo buscado: <span>" + algoritmo + "</span>");
        out.println("</div>");
        ...
        out.println("<i class='bi bi-cpu me-1'></i> ALGORITMO ENCONTRADO");
        out.println("</div>");
        ...
        if (resultado != null && !resultado.isEmpty() && !resultado.equals("vazio")) {
            ...
            out.println("<span class='badge-custom'><i class='bi bi-tag'></i> Algoritmo</span>");
            ...
            out.println("<p style='margin-top: 10px; color: var(--text-secondary);'>Não foi encontrado nenhum algoritmo para o termo \"" + algoritmo + "\"</p>");
            out.println("</div>");
        }
