...
/**
 * Servlet implementation class Formulario9 - Search Algorithm
 */
@WebServlet("/Form_09")
public class Form_09 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<title>InfoSecSoS Ontology - Algorithm Search Result</title>");
        ...
        out.println("<div class='subtitle'><i class='bi bi-search me-1'></i> Algorithm Search Result</div>");
        out.println("</div>");
        ...
        out.println("Search term: <span>" + algoritmo + "</span>");
        out.println("</div>");
        ...
        out.println("<i class='bi bi-cpu me-1'></i> ALGORITHM FOUND");
        out.println("</div>");
        ...
        if (resultado != null && !resultado.isEmpty() && !resultado.equals("empty")) {
            ...
            out.println("<span class='badge-custom'><i class='bi bi-tag'></i> Algorithm</span>");
            ...
            out.println("<p style='margin-top: 10px; color: var(--text-secondary);'>No algorithm found for the term \"" + algoritmo + "\"</p>");
            out.println("</div>");
        }
