...
public class Form_01 extends HttpServlet {
	...
	protected void doGet(final HttpServletRequest req, final HttpServletResponse res)
		...
		out.println("<title>InfoSecSoSSoS Ontology - Query Result</title>");
		...
		out.println("<div class='subtitle'><i class='bi bi-check-circle me-1'></i> Query Result - Question 1</div>");
		out.println("</div>");
		...
		out.println("<div class='stat-label'>Classes Found</div>");
		out.println("</div>");
		...
		out.println("<div><strong>Information Security in systems-of-systems</strong> is divided into <strong>" + numero
				+ " main classes</strong>.</div>");
		out.println("</div>");

		// Section Title
		out.println("<div class='section-title'>");
		out.println("<i class='bi bi-list-ul'></i>");
		out.println("Classes Identified in the ontology");
		...
		if (list.isEmpty()) {
			...
			for (int i = 0; i < list.size(); i++) {
				...
				out.println("<i class='bi bi-tag'></i> Security Class");
				out.println("<span class='badge-custom ms-2'><i class='bi bi-shield'></i> InfoSecSoS</span>");
				out.println("</div>");
				out.println("</div>");
