...
public class Form_01 extends HttpServlet {
    ...
    protected void doGet(final HttpServletRequest req, final HttpServletResponse res)
        ...
        try {
            ...
            resposta1 = principal.transformarInstancia(resposta);
        ...
        out.println("<title>InfoSecSoS Ontology - Resultado da Consulta</title>");
        ...
        out.println("    background: linear-gradient(135deg, var(--primary-color), var(--secondary-color));");
        ...
        out.println("    color: white;");
        out.println("    text-align: center;");
        out.println("    box-shadow: 0 10px 30px -5px rgba(102, 126, 234, 0.4);");
        ...
        out.println("    box-shadow: 0 10px 20px -5px rgba(99, 102, 241, 0.2);");
        out.println("}");
        out.println("");
        ...
        out.println("    box-shadow: 0 4px 10px rgba(99, 102, 241, 0.3);");
        out.println("}");
        out.println("");
        ...
        out.println("    border-left: 4px solid #0284c7;");
        out.println("}");
        out.println("");
        ...
        out.println("    box-shadow: 0 10px 20px -5px rgba(99, 102, 241, 0.4);");
        out.println("    border: none;");
        out.println("}");
        out.println("");
        out.println(".btn-primary:hover {");
        out.println("    transform: translateY(-3px);");
        out.println("    box-shadow: 0 20px 25px -5px rgba(99, 102, 241, 0.5);");
        out.println("    color: white;");
        out.println("}");
        out.println("");
        ...
        out.println("    background: white;");
        out.println("    color: var(--primary-color);");
        out.println("    border: 2px solid var(--primary-color);");
        ...
        out.println("    color: white;");
        out.println("    transform: translateY(-3px);");
        out.println("    box-shadow: 0 10px 20px -5px rgba(99, 102, 241, 0.3);");
        out.println("}");
        out.println("");
        ...
        out.println("    box-shadow: 0 15px 30px -5px rgba(99, 102, 241, 0.5);");
        out.println("    cursor: pointer;");
        out.println("    transition: all 0.3s ease;");
        ...
        out.println("    background: linear-gradient(135deg, var(--secondary-color), var(--primary-color));");
        out.println("    box-shadow: 0 20px 35px -5px rgba(99, 102, 241, 0.6);");
        out.println("}");
        out.println("");
        out.println(".badge-custom {");
        out.println("    background: rgba(99, 102, 241, 0.1);");
        out.println("    color: var(--primary-color);");
        ...
        out.println("<div class='subtitle'><i class='bi bi-check-circle me-1'></i> Resultado da Consulta - Questão 1</div>");
        out.println("</div>");
        ...
        out.println("<div class='stat-icon'><i class='bi bi-diagram-3'></i></div>");
        out.println("<div class='stat-number'>" + numero + "</div>");
        out.println("<div class='stat-label'>Classes Encontradas</div>");
        out.println("</div>");
        ...
        out.println("<div><strong>Information Security in systems-of-systems</strong> está dividida em <strong>" + numero + " classes</strong> principais.</div>");
        out.println("</div>");
        
        // Section Title
        out.println("<div class='section-title'>");
        out.println("<i class='bi bi-list-ul'></i>");
        out.println("Classes Identificadas na Ontologia");
        ...
        if (list.isEmpty()) {
            ...
            out.println("<p style='margin-top: 15px;'>Nenhuma classe encontrada</p>");
            out.println("</div>");
        } else {
            for (int i = 0; i < list.size(); i++) {
                ...
                out.println("<i class='bi bi-tag'></i> Classe de segurança");
                out.println("<span class='badge-custom ms-2'><i class='bi bi-shield'></i> InfoSec</span>");
                out.println("</div>");
                out.println("</div>");
