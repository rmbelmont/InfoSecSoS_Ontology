...
public class Form_03 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            resposta = principal.TecnologiasFatoresEspecificos();
            ...
            numero = principal.TecnologiasFatoresEspecificoInteger();
        ...
        out.println("<title>InfoSecSoSSoS Ontology - Specific Factors</title>");
        ...
        out.println("<style>");
        out.println(":root {");
        out.println("    --primary-color: #10b981;");
        out.println("    --primary-dark: #059669;");
        out.println("    --secondary-color: #34d399;");
        ...
        out.println("    background: linear-gradient(135deg, #10b981, #34d399);");
        ...
        out.println("    color: white;");
        out.println("    text-align: center;");
        out.println("    box-shadow: 0 10px 30px -5px rgba(16, 185, 129, 0.4);");
        ...
        out.println("    border-color: #10b981;");
        out.println("    box-shadow: 0 10px 20px -5px rgba(16, 185, 129, 0.2);");
        out.println("}");
        out.println("");
        ...
        out.println("    box-shadow: 0 4px 10px rgba(16, 185, 129, 0.3);");
        out.println("}");
        out.println("");
        ...
        out.println("    border-left: 4px solid #10b981;");
        out.println("}");
        out.println("");
        ...
        out.println("    box-shadow: 0 10px 20px -5px rgba(16, 185, 129, 0.4);");
        out.println("    border: none;");
        out.println("}");
        out.println("");
        out.println(".btn-primary:hover {");
        out.println("    transform: translateY(-3px);");
        out.println("    box-shadow: 0 20px 25px -5px rgba(16, 185, 129, 0.5);");
        out.println("    color: white;");
        out.println("}");
        out.println("");
        ...
        out.println("    background: white;");
        out.println("    color: #10b981;");
        out.println("    border: 2px solid #10b981;");
        ...
        out.println("    color: white;");
        out.println("    transform: translateY(-3px);");
        out.println("    box-shadow: 0 10px 20px -5px rgba(16, 185, 129, 0.3);");
        out.println("}");
        out.println("");
        ...
        out.println("    box-shadow: 0 15px 30px -5px rgba(16, 185, 129, 0.5);");
        out.println("    cursor: pointer;");
        out.println("    transition: all 0.3s ease;");
        ...
        out.println("    background: linear-gradient(135deg, #34d399, #10b981);");
        out.println("    box-shadow: 0 20px 35px -5px rgba(16, 185, 129, 0.6);");
        out.println("}");
        out.println("");
        ...
        out.println("<div class='subtitle'><i class='bi bi-pin-angle me-1'></i> Specific Factors</div>");
        out.println("</div>");
        ...
        out.println("<div class='stat-icon'><i class='bi bi-pin-angle-fill'></i></div>");
        out.println("<div class='stat-number'>" + numero + "</div>");
        out.println("<div class='stat-label'>Specific Factors</div>");
        out.println("</div>");
        ...
        out.println("<div><strong>The amount of " + numero + " Specific Factors!</strong> Complete list of specific security factors.</div>");
        out.println("</div>");
        
        // Section Title
        out.println("<div class='section-title'>");
        out.println("<i class='bi bi-pin-map-fill'></i>");
        out.println("Specific Factors Identified");
        out.println("<span class='badge-custom ms-2'><i class='bi bi-tag'></i> " + list.size() + " itens</span>");
        out.println("</div>");
        
        // Lista de fatores específicos
        ...
        if (list.isEmpty()) {
            ...
            out.println("<p style='margin-top: 15px;'>No specific factors found</p>");
            out.println("</div>");
        } else {
            for (int i = 0; i < list.size(); i++) {
                ...
                out.println("<i class='bi bi-tag'></i> Specific Factor");
                out.println("<span class='badge-custom ms-2'><i class='bi bi-pin'></i> InfoSecSoS</span>");
                out.println("</div>");
                out.println("</div>");
        ...
        out.println("<i class='bi bi-arrow-left-circle'></i> New Query");
        out.println("</button>");
