...
/**
 * Servlet implementation class Formulario5
 */
@WebServlet("/Form_05")
public class Form_05 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            numero = principal.AvaliacaoInteger();
        ...
        out.println("<style>");
        out.println(":root {");
        out.println("    --primary-color: #a855f7;");
        out.println("    --primary-dark: #9333ea;");
        out.println("    --secondary-color: #c084fc;");
        ...
        out.println("    background: linear-gradient(135deg, #a855f7, #c084fc);");
        ...
        out.println("    color: white;");
        out.println("    text-align: center;");
        out.println("    box-shadow: 0 10px 30px -5px rgba(168, 85, 247, 0.4);");
        ...
        out.println("    border-color: #a855f7;");
        out.println("    box-shadow: 0 10px 20px -5px rgba(168, 85, 247, 0.2);");
        out.println("}");
        out.println("");
        ...
        out.println("    box-shadow: 0 4px 10px rgba(168, 85, 247, 0.3);");
        out.println("}");
        out.println("");
        ...
        out.println("    background: #f3e8ff;");
        out.println("    color: #6b21a8;");
        ...
        out.println("    border-left: 4px solid #a855f7;");
        out.println("}");
        out.println("");
        ...
        out.println("    box-shadow: 0 10px 20px -5px rgba(168, 85, 247, 0.4);");
        out.println("    border: none;");
        out.println("}");
        out.println("");
        out.println(".btn-primary:hover {");
        out.println("    transform: translateY(-3px);");
        out.println("    box-shadow: 0 20px 25px -5px rgba(168, 85, 247, 0.5);");
        out.println("    color: white;");
        out.println("}");
        out.println("");
        ...
        out.println("    background: white;");
        out.println("    color: #a855f7;");
        out.println("    border: 2px solid #a855f7;");
        ...
        out.println("    background: #a855f7;");
        out.println("    color: white;");
        out.println("    transform: translateY(-3px);");
        out.println("    box-shadow: 0 10px 20px -5px rgba(168, 85, 247, 0.3);");
        out.println("}");
        out.println("");
        ...
        out.println("    box-shadow: 0 15px 30px -5px rgba(168, 85, 247, 0.5);");
        out.println("    cursor: pointer;");
        out.println("    transition: all 0.3s ease;");
        ...
        out.println("    background: linear-gradient(135deg, #c084fc, #a855f7);");
        out.println("    box-shadow: 0 20px 35px -5px rgba(168, 85, 247, 0.6);");
        out.println("}");
        out.println("");
        out.println(".badge-custom {");
        out.println("    background: rgba(168, 85, 247, 0.1);");
        out.println("    color: #a855f7;");
