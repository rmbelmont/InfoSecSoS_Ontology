...
/**
 * Servlet implementation class Form_10 - Domínios de Aplicação
 */
@WebServlet("/Form_10")
public class Form_10 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<title>InfoSecSoS Ontology - Domínios de Aplicação</title>");
        ...
        out.println("<div class='subtitle'><i class='bi bi-globe me-1'></i> Domínios de Aplicação</div>");
        out.println("</div>");
        ...
        out.println("<div class='stat-label'>Domínios de Aplicação</div>");
        out.println("</div>");
        ...
        out.println("<div><strong>The amount of " + numero + " Application Domains!</strong> Lista completa de domínios de aplicação em sistemas-de-sistemas.</div>");
        out.println("</div>");
        
        // Section Title
        out.println("<div class='section-title'>");
        out.println("<i class='bi bi-diagram-3-fill'></i>");
        out.println("Domínios de Aplicação Identificados");
        ...
        if (list.isEmpty()) {
            ...
            out.println("<p style='margin-top: 15px;'>Nenhum domínio de aplicação encontrado</p>");
            out.println("</div>");
        } else {
            for (int i = 0; i < list.size(); i++) {
                ...
                out.println("<i class='bi bi-tag'></i> Domínio de aplicação");
                out.println("<span class='badge-custom ms-2'><i class='bi bi-globe'></i> InfoSec</span>");
                out.println("</div>");
                out.println("</div>");
