...
/**
 * Servlet implementation class Form_10 - Application Domains
 */
@WebServlet("/Form_10")
public class Form_10 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            resposta = principal.Application_Domain();
            ...
            numero = principal.Application_DomainInteger();
        ...
        out.println("<title>InfoSecSoS Ontology - Application Domains</title>");
        ...
        out.println("<style>");
        out.println(":root {");
        out.println("    --primary-color: #8b5cf6;");
        out.println("    --primary-dark: #7c3aed;");
        out.println("    --secondary-color: #a78bfa;");
        ...
        out.println("    background: linear-gradient(135deg, #8b5cf6, #a78bfa);");
        ...
        out.println("    color: white;");
        out.println("    text-align: center;");
        out.println("    box-shadow: 0 10px 30px -5px rgba(139, 92, 246, 0.4);");
        ...
        out.println("    border-color: #8b5cf6;");
        out.println("    box-shadow: 0 10px 20px -5px rgba(139, 92, 246, 0.2);");
        out.println("}");
        out.println("");
        ...
        out.println("    box-shadow: 0 4px 10px rgba(139, 92, 246, 0.3);");
        out.println("}");
        out.println("");
        ...
        out.println("    border-left: 4px solid #8b5cf6;");
        out.println("}");
        out.println("");
        ...
        out.println("    box-shadow: 0 10px 20px -5px rgba(139, 92, 246, 0.4);");
        out.println("    border: none;");
        out.println("}");
        out.println("");
        out.println(".btn-primary:hover {");
        out.println("    transform: translateY(-3px);");
        out.println("    box-shadow: 0 20px 25px -5px rgba(139, 92, 246, 0.5);");
        out.println("    color: white;");
        out.println("}");
        out.println("");
        ...
        out.println("    background: white;");
        out.println("    color: #8b5cf6;");
        out.println("    border: 2px solid #8b5cf6;");
        ...
        out.println("    background: #8b5cf6;");
        out.println("    color: white;");
        out.println("    transform: translateY(-3px);");
        out.println("    box-shadow: 0 10px 20px -5px rgba(139, 92, 246, 0.3);");
        out.println("}");
        out.println("");
        ...
        out.println("    box-shadow: 0 15px 30px -5px rgba(139, 92, 246, 0.5);");
        out.println("    cursor: pointer;");
        out.println("    transition: all 0.3s ease;");
        ...
        out.println("    background: linear-gradient(135deg, #a78bfa, #8b5cf6);");
        out.println("    box-shadow: 0 20px 35px -5px rgba(139, 92, 246, 0.6);");
        out.println("}");
        out.println("");
        out.println(".badge-custom {");
        out.println("    background: rgba(139, 92, 246, 0.1);");
        out.println("    color: #8b5cf6;");
        ...
        out.println("<div class='subtitle'><i class='bi bi-globe me-1'></i> Application Domains</div>");
        out.println("</div>");
        ...
        out.println("<div class='stat-icon'><i class='bi bi-globe'></i></div>");
        out.println("<div class='stat-number'>" + numero + "</div>");
        out.println("<div class='stat-label'>Application Domains</div>");
        out.println("</div>");
        ...
        out.println("<div><strong>The amount of " + numero + " Application Domains!</strong> Complete list of application domains in systems-of-systems.</div>");
        out.println("</div>");
        
        // Section Title
        out.println("<div class='section-title'>");
        out.println("<i class='bi bi-diagram-3-fill'></i>");
        out.println("Application Domains Identified");
        out.println("<span class='badge-custom ms-2'><i class='bi bi-tag'></i> " + list.size() + " items</span>");
        out.println("</div>");
        
        // Lista de domínios de aplicação
        ...
        if (list.isEmpty()) {
            ...
            out.println("<p style='margin-top: 15px;'>No application domain found</p>");
            out.println("</div>");
        } else {
            for (int i = 0; i < list.size(); i++) {
                ...
                out.println("<i class='bi bi-tag'></i> Application Domain");
                out.println("<span class='badge-custom ms-2'><i class='bi bi-globe'></i> InfoSecSoS</span>");
                out.println("</div>");
                out.println("</div>");
        ...
        out.println("    // Intersection Observer for animations");
