...
/**
 * Servlet implementation class Formulario4
 */
@WebServlet("/Form_04")
public class Form_04 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            resposta = principal.FatoresHumanos();
            ...
            numero = principal.FatoresHumanosInteger();
        ...
        out.println("<style>");
        out.println(":root {");
        out.println("    --primary-color: #ec4899;");
        out.println("    --primary-dark: #db2777;");
        out.println("    --secondary-color: #f472b6;");
        ...
        out.println("    background: linear-gradient(135deg, #ec4899, #f472b6);");
        ...
        out.println("    color: white;");
        out.println("    text-align: center;");
        out.println("    box-shadow: 0 10px 30px -5px rgba(236, 72, 153, 0.4);");
        ...
        out.println("    border-color: #ec4899;");
        out.println("    box-shadow: 0 10px 20px -5px rgba(236, 72, 153, 0.2);");
        out.println("}");
        out.println("");
        ...
        out.println("    box-shadow: 0 4px 10px rgba(236, 72, 153, 0.3);");
        out.println("}");
        out.println("");
        ...
        out.println("    background: #fdf2f8;");
        out.println("    color: #9d174d;");
        ...
        out.println("    border-left: 4px solid #ec4899;");
        out.println("}");
        out.println("");
        ...
        out.println("    box-shadow: 0 10px 20px -5px rgba(236, 72, 153, 0.4);");
        out.println("    border: none;");
        out.println("}");
        out.println("");
        out.println(".btn-primary:hover {");
        out.println("    transform: translateY(-3px);");
        out.println("    box-shadow: 0 20px 25px -5px rgba(236, 72, 153, 0.5);");
        out.println("    color: white;");
        out.println("}");
        out.println("");
        ...
        out.println("    background: white;");
        out.println("    color: #ec4899;");
        out.println("    border: 2px solid #ec4899;");
        ...
        out.println("    background: #ec4899;");
        out.println("    color: white;");
        out.println("    transform: translateY(-3px);");
        out.println("    box-shadow: 0 10px 20px -5px rgba(236, 72, 153, 0.3);");
        out.println("}");
        out.println("");
        ...
        out.println("    box-shadow: 0 15px 30px -5px rgba(236, 72, 153, 0.5);");
        out.println("    cursor: pointer;");
        out.println("    transition: all 0.3s ease;");
        ...
        out.println("    background: linear-gradient(135deg, #f472b6, #ec4899);");
        out.println("    box-shadow: 0 20px 35px -5px rgba(236, 72, 153, 0.6);");
        out.println("}");
        out.println("");
        out.println(".badge-custom {");
        out.println("    background: rgba(236, 72, 153, 0.1);");
        out.println("    color: #ec4899;");
