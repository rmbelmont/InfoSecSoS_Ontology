...
/**
 * Servlet implementation class Form_11 - Threat Types
 */
@WebServlet("/Form_11")
public class Form_11 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            resposta = principal.Threat_Type();
            ...
            numero = principal.Threat_Type_Integer();
        ...
        out.println("<title>InfoSecSoS Ontology - Threat Types</title>");
        ...
        out.println("<style>");
        out.println(":root {");
        out.println("    --primary-color: #ef4444;");
        out.println("    --primary-dark: #dc2626;");
        out.println("    --secondary-color: #f87171;");
        ...
        out.println("    background: linear-gradient(135deg, #ef4444, #f87171);");
        ...
        out.println("    color: white;");
        out.println("    text-align: center;");
        out.println("    box-shadow: 0 10px 30px -5px rgba(239, 68, 68, 0.4);");
        ...
        out.println("    border-color: #ef4444;");
        out.println("    box-shadow: 0 10px 20px -5px rgba(239, 68, 68, 0.2);");
        out.println("}");
        out.println("");
        ...
        out.println("    box-shadow: 0 4px 10px rgba(239, 68, 68, 0.3);");
        out.println("}");
        out.println("");
        ...
        out.println("    border-left: 4px solid #ef4444;");
        out.println("}");
        out.println("");
        ...
        out.println("    box-shadow: 0 10px 20px -5px rgba(239, 68, 68, 0.4);");
        out.println("    border: none;");
        out.println("}");
        out.println("");
        out.println(".btn-primary:hover {");
        out.println("    transform: translateY(-3px);");
        out.println("    box-shadow: 0 20px 25px -5px rgba(239, 68, 68, 0.5);");
        out.println("    color: white;");
        out.println("}");
        out.println("");
        ...
        out.println("    background: white;");
        out.println("    color: #ef4444;");
        out.println("    border: 2px solid #ef4444;");
        ...
        out.println("    color: white;");
        out.println("    transform: translateY(-3px);");
        out.println("    box-shadow: 0 10px 20px -5px rgba(239, 68, 68, 0.3);");
        out.println("}");
        out.println("");
        ...
        out.println("    box-shadow: 0 15px 30px -5px rgba(239, 68, 68, 0.5);");
        out.println("    cursor: pointer;");
        out.println("    transition: all 0.3s ease;");
        ...
        out.println("    background: linear-gradient(135deg, #f87171, #ef4444);");
        out.println("    box-shadow: 0 20px 35px -5px rgba(239, 68, 68, 0.6);");
        out.println("}");
        out.println("");
        out.println(".badge-custom {");
        out.println("    background: rgba(239, 68, 68, 0.1);");
        out.println("    color: #ef4444;");
        ...
        out.println("<div class='subtitle'><i class='bi bi-exclamation-triangle me-1'></i> Threat Types</div>");
        out.println("</div>");
        ...
        out.println("<div class='stat-icon'><i class='bi bi-exclamation-triangle-fill'></i></div>");
        out.println("<div class='stat-number'>" + numero + "</div>");
        out.println("<div class='stat-label'>Threat Types</div>");
        out.println("</div>");
        ...
        out.println("<div><strong>The amount of " + numero + " Threat Types!</strong> Complete list of threat types in systems-of-systems.</div>");
        out.println("</div>");
        
        // Section Title
        out.println("<div class='section-title'>");
        out.println("<i class='bi bi-shield-exclamation'></i>");
        out.println("Threat Types Identified");
        out.println("<span class='badge-custom ms-2'><i class='bi bi-tag'></i> " + list.size() + " items</span>");
        out.println("</div>");
        
        // Lista de tipos de ameaças
        ...
        if (list.isEmpty()) {
            ...
            out.println("<p style='margin-top: 15px;'>No threat type found</p>");
            out.println("</div>");
        } else {
            for (int i = 0; i < list.size(); i++) {
                ...
                out.println("<i class='bi bi-tag'></i> Threat Type");
                out.println("<span class='badge-custom ms-2'><i class='bi bi-exclamation-triangle'></i> InfoSecSoS</span>");
                out.println("</div>");
                out.println("</div>");
