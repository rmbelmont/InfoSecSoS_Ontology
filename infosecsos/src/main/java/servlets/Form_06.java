...
public class Form_06 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<title>InfoSecSoS Ontology - Encryption Solutions</title>");
        ...
        out.println("<div class='subtitle'><i class='bi bi-lock-fill me-1'></i> Encryption Solutions</div>");
        out.println("</div>");
        ...
        out.println("<div class='stat-label'>Encryption Solutions</div>");
        out.println("</div>");
        ...
        out.println("<div><strong>The amount of " + numero + " Encryption Solutions!</strong> Complete list of encryption solutions found in systems-of-systems.</div>");
        out.println("</div>");
        
        // Section Title
        out.println("<div class='section-title'>");
        out.println("<i class='bi bi-shield-lock-fill'></i>");
        out.println("Encryption Solutions Identified");
        ...
        if (list.isEmpty()) {
            ...
            out.println("<p style='margin-top: 15px;'>No encryption solution found</p>");
            out.println("</div>");
        } else {
            for (int i = 0; i < list.size(); i++) {
                ...
                out.println("<i class='bi bi-tag'></i> Encryption");
                out.println("<span class='badge-custom ms-2'><i class='bi bi-key'></i> InfoSecSoS</span>");
                out.println("</div>");
                out.println("</div>");
