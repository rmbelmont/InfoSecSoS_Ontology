...
/**
 * Servlet implementation class Formulario6
 */
@WebServlet("/Form_06")
public class Form_06 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            numero = principal.CriptografiaInteger();
        ...
        out.println("<title>InfoSecSoS Ontology - Soluções de Criptografia</title>");
        ...
        out.println("    color: white;");
        out.println("    text-align: center;");
        out.println("    box-shadow: 0 10px 30px -5px rgba(59, 130, 246, 0.4);");
        ...
        out.println("    border-color: #3b82f6;");
        out.println("    box-shadow: 0 10px 20px -5px rgba(59, 130, 246, 0.2);");
        out.println("}");
        out.println("");
        ...
        out.println("    box-shadow: 0 4px 10px rgba(59, 130, 246, 0.3);");
        out.println("}");
        out.println("");
        ...
        out.println("<div class='subtitle'><i class='bi bi-lock-fill me-1'></i> Soluções de Criptografia</div>");
        out.println("</div>");
        ...
        out.println("<div class='stat-icon'><i class='bi bi-lock-fill'></i></div>");
        out.println("<div class='stat-number'>" + numero + "</div>");
        out.println("<div class='stat-label'>Soluções de Criptografia</div>");
        out.println("</div>");
        ...
        out.println("<div><strong>The amount of " + numero + " Encryptions!</strong> Lista completa de soluções de criptografia encontradas em sistemas-de-sistemas.</div>");
        out.println("</div>");
        
        // Section Title
        out.println("<div class='section-title'>");
        out.println("<i class='bi bi-shield-lock-fill'></i>");
        out.println("Soluções de Criptografia Identificadas");
        out.println("<span class='badge-custom ms-2'><i class='bi bi-tag'></i> " + list.size() + " itens</span>");
        out.println("</div>");
        
        // Lista de soluções de criptografia
        ...
        if (list.isEmpty()) {
            ...
            out.println("<p style='margin-top: 15px;'>Nenhuma solução de criptografia encontrada</p>");
            out.println("</div>");
        } else {
            for (int i = 0; i < list.size(); i++) {
                ...
                out.println("<i class='bi bi-tag'></i> Criptografia");
                out.println("<span class='badge-custom ms-2'><i class='bi bi-key'></i> InfoSec</span>");
                out.println("</div>");
                out.println("</div>");
