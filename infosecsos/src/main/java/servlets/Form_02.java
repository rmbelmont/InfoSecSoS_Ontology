...
public class Form_02 extends HttpServlet {
	...
	protected void doGet(final HttpServletRequest req, final HttpServletResponse res)
		...
		out.println("<title>InfoSecSoSSoS Ontology - Security Technologies</title>");
		...
		out.println("<div class='subtitle'><i class='bi bi-gear me-1'></i> Technologies, Models and Tools</div>");
		out.println("</div>");
		...
		out.println("<div class='stat-label'>Technologies Found</div>");
		out.println("</div>");
		...
		out.println("<div><strong>  The amount of " + numero
				+ " technologies! </strong> Complete list of technologies, models and tools.</div>");
		out.println("</div>");

		// Section Title
		out.println("<div class='section-title'>");
		out.println("<i class='bi bi-gear-fill'></i>");
		out.println("Technologies, Models and Tools");
		...
		if (list.isEmpty()) {
			...
			out.println("<p style='margin-top: 15px;'> No technologies found</p>");
			out.println("</div>");
		} else {
			for (int i = 0; i < list.size(); i++) {
				...
				out.println("<i class='bi bi-tag'></i> Technology");
				out.println("<span class='badge-custom ms-2'><i class='bi bi-gear'></i> InfoSecSoS</span>");
				out.println("</div>");
				out.println("</div>");
		...
		out.println("<button onclick=\"window.location.href='" + req.getContextPath()
		...
		out.println(
				"                    this.innerHTML = '<span class=\"spinner-border spinner-border-sm me-2\" role=\"status\"></span> Processando...';");
