...
public class Form_02 extends HttpServlet {
    ...
    protected void doGet(final HttpServletRequest req, final HttpServletResponse res)
        ...
        try {
            ...
            numero = principal.TecnicasInteger();
        ...
        out.println("<title>InfoSecSoS Ontology - Tecnologias de Segurança</title>");
        ...
        // CSS Customizado (mesmo estilo do Form_01)
        out.println("<style>");
        out.println(":root {");
        out.println("    --primary-color: #6366f1;");
        out.println("    --primary-dark: #4f46e5;");
        out.println("    --secondary-color: #8b5cf6;");
        ...
        out.println("    background: linear-gradient(135deg, #f97316, #f59e0b);");
        ...
        out.println("    color: white;");
        out.println("    text-align: center;");
        out.println("    box-shadow: 0 10px 30px -5px rgba(249, 115, 22, 0.4);");
        ...
        out.println("    border-color: #f97316;");
        out.println("    box-shadow: 0 10px 20px -5px rgba(249, 115, 22, 0.2);");
        out.println("}");
        out.println("");
        ...
        out.println("    box-shadow: 0 4px 10px rgba(249, 115, 22, 0.3);");
        out.println("}");
        out.println("");
        ...
        out.println("    background: #fff7ed;");
        out.println("    color: #9a3412;");
        ...
        out.println("    border-left: 4px solid #f97316;");
        out.println("}");
        out.println("");
        ...
        out.println("    box-shadow: 0 10px 20px -5px rgba(249, 115, 22, 0.4);");
        out.println("    border: none;");
        out.println("}");
        out.println("");
        out.println(".btn-primary:hover {");
        out.println("    transform: translateY(-3px);");
        out.println("    box-shadow: 0 20px 25px -5px rgba(249, 115, 22, 0.5);");
        out.println("    color: white;");
        out.println("}");
        out.println("");
        ...
        out.println("    background: white;");
        out.println("    color: #f97316;");
        out.println("    border: 2px solid #f97316;");
        ...
        out.println("    background: #f97316;");
        out.println("    color: white;");
        out.println("    transform: translateY(-3px);");
        out.println("    box-shadow: 0 10px 20px -5px rgba(249, 115, 22, 0.3);");
        out.println("}");
        out.println("");
        ...
        out.println("    box-shadow: 0 15px 30px -5px rgba(249, 115, 22, 0.5);");
        out.println("    cursor: pointer;");
        out.println("    transition: all 0.3s ease;");
        ...
        out.println("    background: linear-gradient(135deg, #f59e0b, #f97316);");
        out.println("    box-shadow: 0 20px 35px -5px rgba(249, 115, 22, 0.6);");
        out.println("}");
        out.println("");
        out.println(".badge-custom {");
        out.println("    background: rgba(249, 115, 22, 0.1);");
        out.println("    color: #f97316;");
        ...
        out.println("<div class='subtitle'><i class='bi bi-gear me-1'></i> Tecnologias, Modelos e Ferramentas</div>");
        out.println("</div>");
        ...
        out.println("<div class='stat-label'>Tecnologias Encontradas</div>");
        out.println("</div>");
        
        out.println("<div class='stat-card' style=\"background: linear-gradient(135deg, #10b981, #059669);\">");
        ...
        out.println("<div class='stat-card' style=\"background: linear-gradient(135deg, #6366f1, #8b5cf6);\">");
        ...
        out.println("<div><strong>The amount of " + numero + " Technologies!</strong> Lista completa de tecnologias, modelos e ferramentas.</div>");
        out.println("</div>");
        
        // Section Title
        out.println("<div class='section-title'>");
        out.println("<i class='bi bi-gear-fill'></i>");
        out.println("Tecnologias, Modelos e Ferramentas");
        ...
        if (list.isEmpty()) {
            ...
            out.println("<p style='margin-top: 15px;'>Nenhuma tecnologia encontrada</p>");
            out.println("</div>");
        } else {
            for (int i = 0; i < list.size(); i++) {
                ...
                out.println("<i class='bi bi-tag'></i> Tecnologia de segurança");
                out.println("<span class='badge-custom ms-2'><i class='bi bi-gear'></i> InfoSec</span>");
                out.println("</div>");
                out.println("</div>");
        ...
        out.println("<button onclick=\"window.location.href='" + req.getContextPath() + "/index.jsp'\" class='btn-primary'>");
    ...
    //    RequestDispatcher requestDispatcher = req.getRequestDispatcher("/greet.jsp");
